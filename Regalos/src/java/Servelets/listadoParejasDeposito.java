 ...
 * @author Usuario
 */
@WebServlet(name = "listadoParejasDeposito", urlPatterns = {"/listadoParejasDeposito"})
public class listadoParejasDeposito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<DTOParejasDepositos> listaParejasDeposito = gestor.listaParejasXDepositos();
        
        double totalFacturado = gestor.totalFacturado();

        request.setAttribute("listaParejasDeposito", listaParejasDeposito);
