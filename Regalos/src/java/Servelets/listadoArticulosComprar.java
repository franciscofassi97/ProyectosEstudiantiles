 ...
 * @author Usuario
 */
@WebServlet(name = "listadoArticulosComprar", urlPatterns = {"/listadoArticulosComprar"})
public class listadoArticulosComprar extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listaCombo", comboParejas);
        
        RequestDispatcher rd = request.getRequestDispatcher("/listadoArticulosComprar.jsp");
        rd.forward(request, response);
